...
A free and open-source admin dashboard template built with Next.js, Tailwind CSS and shadcn/ui. It ships with 60+ prebuilt pages (dashboards, e-commerce, a project management app, chat, mail, auth flows and more), all wired up with demo data so you can clone it and start building instead of setting up tables, charts and forms from scratch.
...
- 60+ pages and views across dashboards, e-commerce, CRM, project management and apps
- Light and dark mode
...
- **Dashboards:** Overview, Analytics, E-Commerce, CRM, Reports
- **E-Commerce:** Products, Orders, Customers, Invoices, Categories, Inventory, Discounts, Shipping, Reviews, Cart, Checkout (with list / detail / create / edit where it makes sense)
